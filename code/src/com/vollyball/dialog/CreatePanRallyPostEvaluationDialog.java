...
import com.vollyball.panels.PanRallyPostEvaluation;
 ...
 */
public class CreatePanRallyPostEvaluationDialog {
...
//            UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());
            ...
            this.dialog = new JDialog(this.parentFrame, "", true);
...
//            this.dialog.setSize(682, 750);
    ...
    protected Container createPane() {
        PanRallyPostEvaluation panRallyPostEvaluation = new PanRallyPostEvaluation();

        return panRallyPostEvaluation;
